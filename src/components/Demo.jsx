...
import { airbnb, apple } from "../assets copy/index";
  ...
  return (
    <section className='mt-16 w-full max-w-xl'>
      ...
      <div className='flex flex-col w-full gap-2'>
        ...
        >
          <i
            className='fa-solid fa-copy text-gray-600 text-lg absolute left-0 my-0 ml-3 w-5'
          />
          <i className=""></i>
          <input
            type='url'
                ...
                <div className="px-5">
                  {
                    (copied === item.url)
                      ?
                      <i class="fa-regular fa-circle-check text-gray-600 -ml-2" />
                      :
                      <i
                        className='fa-solid fa-copy text-gray-600 -ml-2 ' />
                  }
                </div>
              </div>
